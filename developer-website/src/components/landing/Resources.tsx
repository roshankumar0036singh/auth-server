      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          {resources.map((resource) => {
            ...
            const content = (
              <>
                <div className="flex items-start justify-between gap-3">
                  <div className="inline-flex rounded-xl border border-zinc-200/80 bg-zinc-50 p-2 text-zinc-700 dark:border-zinc-700/80 dark:bg-zinc-800/50 dark:text-zinc-200">
                    {Icon ? (
            ...
            const className =
              "rounded-2xl border border-zinc-200/80 bg-white p-5 transition-colors hover:border-accent/30 dark:border-zinc-800/80 dark:bg-zinc-900/40 dark:hover:border-accent/30";
